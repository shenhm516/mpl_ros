...
int main(int argc, char **argv) {
  ...
  nh.param("resolution", res, 0.40f);
  nh.param("origin_x", origin_x, -7.0f);
  nh.param("origin_y", origin_y, -18.0f);
  nh.param("origin_z", origin_z, 0.0f);
  nh.param("range_x", range_x, 55.0f);
  nh.param("range_y", range_y, 40.0f);
  nh.param("range_z", range_z, 5.0f);
